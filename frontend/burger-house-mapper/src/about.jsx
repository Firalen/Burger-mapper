     ...
     <div className='flex gap-2 space-x-2'>
        <div>
           <h1 className='font-bold'>⭐ Olivia & Ryan</h1>
            <p>"We tried the rooftop restaurant in the app’s top picks—absolutely<br></br> 
        ...
        <div>
          ...
          <p>"I used to struggle finding new date spots, but this site made it effortless. 
          <br></br>The café recommendations were perfect for a chill first date. Highly recommend!"</p>
        </div>
        <div>
            <h1 className='font-bold'>⭐ Anika R.</h1>
            <p>"Every place I've tried from the list was well-reviewed and lived up to
